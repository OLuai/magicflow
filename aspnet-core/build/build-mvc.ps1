...
$webMvcFolder = Join-Path $slnFolder "src/IA.MagicSuite.Web.Mvc"
$webPublicFolder = Join-Path $slnFolder "src/IA.MagicSuite.Web.Public"
...
dotnet restore IA.MagicSuite.Web.sln
