...
using IA.MagicSuite.Authorization.Users.Profile.Dto;
using IA.MagicSuite.Commands;
using IA.MagicSuite.Core.Threading;
using IA.MagicSuite.Models.NavigationMenu;
using IA.MagicSuite.Services.Navigation;
...
using IA.MagicSuite.Controls;
using IA.MagicSuite.Dto;
using IA.MagicSuite.Extensions;
using IA.MagicSuite.Localization;
using IA.MagicSuite.UI;
using IA.MagicSuite.UI.Assets;
using IA.MagicSuite.Views;
using DependencyResolver = IA.MagicSuite.Core.Dependency.DependencyResolver;
...
namespace IA.MagicSuite.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "MagicSuite";
