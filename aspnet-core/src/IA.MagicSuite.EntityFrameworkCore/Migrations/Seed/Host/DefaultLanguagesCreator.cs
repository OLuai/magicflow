...
namespace IA.MagicSuite.Migrations.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = MagicSuiteConsts.MultiTenancyEnabled ? null : (int?)1;
        ...
        public DefaultLanguagesCreator(MagicSuiteDbContext context)
        {
            _context = context;
        }
