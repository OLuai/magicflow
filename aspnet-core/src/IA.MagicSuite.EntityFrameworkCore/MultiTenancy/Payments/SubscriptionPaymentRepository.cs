...
using IA.MagicSuite.EntityFrameworkCore.Repositories;

namespace IA.MagicSuite.MultiTenancy.Payments
{
    public class SubscriptionPaymentRepository : MagicSuiteRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<MagicSuiteDbContext> dbContextProvider)
