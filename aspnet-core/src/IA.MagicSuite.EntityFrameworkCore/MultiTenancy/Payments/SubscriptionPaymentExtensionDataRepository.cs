...
{
    public class SubscriptionPaymentExtensionDataRepository : MagicSuiteRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<MagicSuiteDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
