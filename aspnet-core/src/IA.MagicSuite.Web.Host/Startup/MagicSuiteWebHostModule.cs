...
using IA.MagicSuite.Web.Startup.ExternalLoginInfoProviders;
...
namespace IA.MagicSuite.Web.Startup
{
    ...
    public class MagicSuiteWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public MagicSuiteWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(MagicSuiteWebHostModule).GetAssembly());
        }
