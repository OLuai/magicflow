...
namespace IA.MagicSuite.Core.Base
{
    public abstract class MagicSuiteQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected MagicSuiteQueryBase(string fieldName,
