...
using IA.MagicSuite.Core.Base;
using IA.MagicSuite.Core.Extensions;
using IA.MagicSuite.Dto;
using IA.MagicSuite.Types;

namespace IA.MagicSuite.Queries
{
    public class OrganizationUnitQuery : MagicSuiteQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
