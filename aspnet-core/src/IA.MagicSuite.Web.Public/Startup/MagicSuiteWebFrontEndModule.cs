...
namespace IA.MagicSuite.Web.Public.Startup
{
    [DependsOn(
        typeof(MagicSuiteWebCoreModule)
    )]
    public class MagicSuiteWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public MagicSuiteWebFrontEndModule(IWebHostEnvironment env, MagicSuiteEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(MagicSuiteWebFrontEndModule).GetAssembly());
        }
    }
}
