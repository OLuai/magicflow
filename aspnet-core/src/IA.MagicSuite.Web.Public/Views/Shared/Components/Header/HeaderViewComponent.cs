...
using IA.MagicSuite.Web.Public.Startup;
using IA.MagicSuite.Web.Session;

namespace IA.MagicSuite.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : MagicSuiteViewComponent
    {
