...
using IA.MagicSuite.Auditing.Exporting;
...
using EntityHistoryHelper = IA.MagicSuite.EntityHistory.EntityHistoryHelper;

namespace IA.MagicSuite.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : MagicSuiteAppServiceBase, IAuditLogAppService
    {
