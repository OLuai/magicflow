...
namespace IA.MagicSuite.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : MagicSuiteAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<MagicSuiteDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{MagicSuiteConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{MagicSuiteConsts.ConnectionStringName}", constring);
        }
