...
using IA.MagicSuite.DynamicEntityPropertyValues.Dto;
...
namespace IA.MagicSuite.DynamicEntityProperties
{
    ...
    public class DynamicEntityPropertyValueAppService : MagicSuiteAppServiceBase, IDynamicEntityPropertyValueAppService
    {
