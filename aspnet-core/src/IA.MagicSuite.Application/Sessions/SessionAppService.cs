...
{
    public class SessionAppService : MagicSuiteAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = MagicSuiteConsts.Currency,
                        CurrencySign = MagicSuiteConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = MagicSuiteConsts.AllowTenantsToChangeEmailSettings,
