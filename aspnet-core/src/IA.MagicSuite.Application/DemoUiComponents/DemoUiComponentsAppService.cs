...
using IA.MagicSuite.DemoUiComponents.Dto;

namespace IA.MagicSuite.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : MagicSuiteAppServiceBase, IDemoUiComponentsAppService
    {
