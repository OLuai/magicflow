...
namespace IA.MagicSuite.Web.TagHelpers
{
    ...
    public class MagicSuitePageSubheaderTagHelper : TagHelper
    {
        ...
        public MagicSuitePageSubheaderTagHelper(IUiThemeCustomizerFactory uiThemeCustomizerFactory)
        {
