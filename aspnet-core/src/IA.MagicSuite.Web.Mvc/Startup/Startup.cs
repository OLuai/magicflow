...
using IA.MagicSuite.Identity;
using IA.MagicSuite.Schemas;
using IA.MagicSuite.Web.Chat.SignalR;
using IA.MagicSuite.Web.Common;
using IA.MagicSuite.Web.Resources;
using Swashbuckle.AspNetCore.Swagger;
using IA.MagicSuite.Web.IdentityServer;
using IA.MagicSuite.Web.Swagger;
using Stripe;
...
using IA.MagicSuite.Web.HealthCheck;
using Owl.reCAPTCHA;
using HealthChecksUISettings = HealthChecks.UI.Configuration.Settings;
using Microsoft.AspNetCore.Server.Kestrel.Https;
using Microsoft.Extensions.DependencyInjection.Extensions;
using SecurityStampValidatorCallback = IA.MagicSuite.Identity.SecurityStampValidatorCallback;

namespace IA.MagicSuite.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            return services.AddAbp<MagicSuiteWebMvcModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "MagicSuite API V1");
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("IA.MagicSuite.Web.wwwroot.swagger.ui.index.html");
        ...
        private void ConfigureSwagger(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new OpenApiInfo() {Title = "MagicSuite API", Version = "v1"});
                ...
                var applicationXml = $"IA.MagicSuite.Application.xml";
                var applicationXmlPath = Path.Combine(AppContext.BaseDirectory, applicationXml);
                options.IncludeXmlComments(applicationXmlPath);

                var webCoreXmlFile = $"IA.MagicSuite.Web.Core.xml";
