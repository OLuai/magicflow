...
using IA.MagicSuite.Web.Areas.App.Models.Languages;
...
namespace IA.MagicSuite.Web.Areas.App.Controllers
{
    ...
    public class LanguagesController : MagicSuiteControllerBase
    {
            ...
            string filterText = "")
        {
            ...
            {
                sourceName = MagicSuiteConsts.LocalizationSourceName;
            }
