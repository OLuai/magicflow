...
using IA.MagicSuite.Configuration.Host;
using IA.MagicSuite.Editions;
using IA.MagicSuite.Timing;
using IA.MagicSuite.Timing.Dto;
using IA.MagicSuite.Web.Areas.App.Models.HostSettings;
...
namespace IA.MagicSuite.Web.Areas.App.Controllers
{
    ...
    public class HostSettingsController : MagicSuiteControllerBase
    {
