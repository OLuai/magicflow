...
namespace IA.MagicSuite.Web.Areas.App.Views.Shared.Themes.Theme9.Components.AppTheme9Footer
{
    public class AppTheme9FooterViewComponent : MagicSuiteViewComponent
    {
