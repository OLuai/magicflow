...
namespace IA.MagicSuite.Web.Areas.App.Views.Shared.Themes.Theme10.Components.AppTheme10Brand
{
    public class AppTheme10BrandViewComponent : MagicSuiteViewComponent
    {
