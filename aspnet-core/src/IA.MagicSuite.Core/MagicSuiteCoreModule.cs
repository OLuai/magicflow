...
using IA.MagicSuite.Authorization.Ldap;
...
using IA.MagicSuite.DashboardCustomization.Definitions;
using IA.MagicSuite.Debugging;
using IA.MagicSuite.DynamicEntityProperties;
using IA.MagicSuite.Features;
using IA.MagicSuite.Friendships;
using IA.MagicSuite.Friendships.Cache;
using IA.MagicSuite.Localization;
using IA.MagicSuite.MultiTenancy;
using IA.MagicSuite.Net.Emailing;
using IA.MagicSuite.Notifications;
using IA.MagicSuite.WebHooks;
using Newtonsoft.Json;

namespace IA.MagicSuite
{
    [DependsOn(
        typeof(MagicSuiteCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class MagicSuiteCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            MagicSuiteLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = MagicSuiteConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, MagicSuiteMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<MagicSuiteSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(MagicSuiteCoreModule).GetAssembly());
        }
