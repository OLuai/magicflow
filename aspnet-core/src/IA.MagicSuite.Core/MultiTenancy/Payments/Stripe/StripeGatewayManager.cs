...
{
    public class StripeGatewayManager : MagicSuiteServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "MagicSuite";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + MagicSuiteConsts.Currency;
        }
