...
namespace IA.MagicSuite.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : MagicSuiteServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("IA.MagicSuite", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
