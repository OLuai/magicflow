...
namespace IA.MagicSuite.Web.Authentication.JwtBearer
{
    public class MagicSuiteJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public MagicSuiteJwtSecurityTokenHandler()
        {
