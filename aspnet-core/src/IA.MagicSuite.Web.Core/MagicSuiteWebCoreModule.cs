...
using IA.MagicSuite.Authentication.TwoFactor;
...
using IA.MagicSuite.Web.Authentication.JwtBearer;
using IA.MagicSuite.Web.Authentication.TwoFactor;
using IA.MagicSuite.Web.Chat.SignalR;
using IA.MagicSuite.Web.Common;
using IA.MagicSuite.Web.Configuration;
using IA.MagicSuite.Web.DashboardCustomization;

namespace IA.MagicSuite.Web
{
    [DependsOn(
        typeof(MagicSuiteApplicationModule),
        typeof(MagicSuiteEntityFrameworkCoreModule),
    ...
    public class MagicSuiteWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public MagicSuiteWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(MagicSuiteApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(MagicSuiteWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(MagicSuiteWebCoreModule).Assembly);
        }
