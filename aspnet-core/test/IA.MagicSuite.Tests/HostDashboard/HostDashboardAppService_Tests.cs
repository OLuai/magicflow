...
using IA.MagicSuite.MultiTenancy.HostDashboard;
...
namespace IA.MagicSuite.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(MagicSuiteDbContext context, SubscriptionPayment subscriptionPayment)
        {
